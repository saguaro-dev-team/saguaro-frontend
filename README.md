...
Saguaro Barefoot es una aplicación web e-commerce de calzado barefoot y minimalista desarrollada sobre **Next.js (App Router)** utilizando **Prisma ORM** para la base de datos PostgreSQL hospedada en la nube de **Supabase**, y estilizada de forma premium con **CSS Vanilla** y componentes accesibles de Radix UI.

---

## 🛠️ Arquitectura de Almacenamiento Híbrido
