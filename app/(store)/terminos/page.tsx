        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 text-primary">
              ...
              <h2 className="text-2xl font-bold tracking-tight text-foreground">2. Precios y Pagos</h2>
            </div>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 text-primary">
              ...
              <h2 className="text-2xl font-bold tracking-tight text-foreground">3. Envíos y Logística</h2>
            </div>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 text-primary">
              ...
              <h2 className="text-2xl font-bold tracking-tight text-foreground">4. Cambios y Devoluciones</h2>
            </div>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 text-primary">
              ...
              <h2 className="text-2xl font-bold tracking-tight text-foreground">5. Propiedad Intelectual</h2>
            </div>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="space-y-4 border-t pt-12">
            <div className="flex items-center gap-3 text-primary">
              ...
              <h2 className="text-2xl font-bold tracking-tight text-foreground">6. Legislación Aplicable</h2>
            </div>
            <p className="text-muted-foreground leading-relaxed">
